...
from .residual_v2_anchor import (
    ...
    strip_compile_prefix_from_state_dict as strip_residual_v2_compile_prefix_from_state_dict,
)
from .residual_v2_cache import (
    ...
    sha256_file as residual_v2_sha256_file,
...
from .residual_v2_report import (
...
__all__ = [
    ...
    "soft_fpr50_v2_loss",
    "standardize_features",
    "strip_residual_v2_compile_prefix_from_state_dict",
    "train_local_graph_residual_expert",
    "train_local_graph_residual_expert_v2",
    "train_local_graph_tagger",
    "validate_prediction_alignment",
