"""Prediction collection for teacher-logit PFN-style reconstructors."""
...
from .particle_flow_reconstructor import ParticleFlowReconstructor
...
from .train_particle_flow import EXPERIMENT_STEP as TRAIN_EXPERIMENT_STEP


PREDICT_EXPERIMENT_STEP = "teacher_logit_reco_step6_particle_flow_predictions"
RECONSTRUCTOR_ARCHITECTURE = "particle_flow"


@dataclass
class TeacherLogitParticleFlowPredictionConfig:
    """Configuration for PFN Step 6 prediction block generation."""
...
def load_particle_flow_reconstructor_checkpoint(
    checkpoint_path: str | Path,
    *,
    device,
    strict: bool = True,
) -> tuple[ParticleFlowReconstructor, Dict[str, Any]]:
    """Load a Step 5 PFN-style reconstructor checkpoint."""
...
def default_model_name_for_teacher_architecture(architecture: str | None) -> str:
    ...
    return f"pfn_reco_to_{arch}_teacher"


def collect_teacher_logit_particle_flow_predictions(
    config: TeacherLogitParticleFlowPredictionConfig,
    *,
    reconstructor=None,
    teacher=None,
    ...
    if reconstructor is None:
        reconstructor, payload = load_particle_flow_reconstructor_checkpoint(
    ...
    checkpoint_metadata = {
        ...
        "model_kind": "teacher_logit_particle_flow_reco",
