"""Prediction collection for teacher-logit ParticleNet-style reconstructors."""
...
from .particle_net_reconstructor import ParticleNetReconstructor
...
from .train_particle_net import EXPERIMENT_STEP as TRAIN_EXPERIMENT_STEP


PREDICT_EXPERIMENT_STEP = "teacher_logit_reco_step6_particle_net_predictions"
RECONSTRUCTOR_ARCHITECTURE = "particle_net"


@dataclass
class TeacherLogitParticleNetPredictionConfig:
    """Configuration for PN Step 6 prediction block generation."""
...
def load_particle_net_reconstructor_checkpoint(
    checkpoint_path: str | Path,
    *,
    device,
    strict: bool = True,
) -> tuple[ParticleNetReconstructor, Dict[str, Any]]:
    """Load a Step 5 ParticleNet-style reconstructor checkpoint."""
...
def default_model_name_for_teacher_architecture(architecture: str | None) -> str:
    ...
    return f"pn_reco_to_{arch}_teacher"


def collect_teacher_logit_particle_net_predictions(
    config: TeacherLogitParticleNetPredictionConfig,
    *,
    reconstructor=None,
    teacher=None,
    ...
    if reconstructor is None:
        reconstructor, payload = load_particle_net_reconstructor_checkpoint(
    ...
    checkpoint_metadata = {
        ...
        "model_kind": "teacher_logit_particle_net_reco",
