...
ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER = "av10_lc_plus_feature_mlp_adapter"
...
ARCHITECTURE_VIEW_10CLASS_VARIANT_TO_BINARY_BEHAVIOR: dict[str, str] = {
    ...
    ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER: ARCHITECTURE_VIEW_VARIANT_CONTEXT_MLP_CONTROL,
...
ARCHITECTURE_VIEW_VARIANT_ALIASES: dict[str, str] = {
    ...
    "av10_lc_plus_feature_mlp": ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER,
    "av10_lc_plus_feature_mlp_adapter": ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER,
    "av10_input_delta_plus_feature_mlp": ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER,
    "av10_combined_adapter": ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER,
...
def architecture_view_variant_specs() -> dict[str, ArchitectureViewVariantSpec]:
    ...
    specs = (
        ...
        ArchitectureViewVariantSpec(
            name=ARCHITECTURE_VIEW_10CLASS_ABLATION_LC_PLUS_FEATURE_MLP_ADAPTER,
            enabled_views=(),
            description=(
                "AV10/PDV3 combined adapter: bounded LC-style delta_F before ParT embedding plus "
                "a separate feature-MLP delta_h after embedding."
            ),
            suite="pdv3_av10_combined_adapter",
            adapter_type="feature_mlp_delta_F_plus_feature_mlp_context",
            parameter_target="combined_input_feature_and_embedding_adapter",
            implementation_step="implemented_pdv3_step6_combined_lc_plus_feature_mlp",
        ),
        ArchitectureViewVariantSpec(
