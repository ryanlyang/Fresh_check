...
: "${LOCAL_COMPRESSION_PART_QCD_HGG_REQUIRE_BASELINE_SPLIT_MANIFEST_HASH:=1}"
...
export LOCAL_COMPRESSION_PART_REQUIRE_BASELINE_SPLIT_MANIFEST_HASH="${LOCAL_COMPRESSION_PART_QCD_HGG_REQUIRE_BASELINE_SPLIT_MANIFEST_HASH}"
...
if ! fresh_is_dry_run; then
  ...
  done
  {
    ...
    echo "require_baseline_split_manifest_hash=${LOCAL_COMPRESSION_PART_REQUIRE_BASELINE_SPLIT_MANIFEST_HASH}"
