...
: "${LOCAL_COMPRESSION_PART_REQUIRE_BASELINE_SPLIT_MANIFEST_HASH:=0}"
...
: "${LOCAL_COMPRESSION_PART_FREEZE_PART_EPOCHS:=0}"
...
fresh_append_flag_if_enabled cmd --require-baseline-split-manifest-hash "${LOCAL_COMPRESSION_PART_REQUIRE_BASELINE_SPLIT_MANIFEST_HASH}"
