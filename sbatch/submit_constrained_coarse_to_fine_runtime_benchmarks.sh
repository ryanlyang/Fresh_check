...
# Benchmark selection consumes metrics/curves only. Retaining hundreds of
# model-plus-optimizer snapshots can exhaust shared home storage.
export CONSTRAINED_C2F_RECO_SAVE_BEST_CHECKPOINT=0
