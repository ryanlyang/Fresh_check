...
if fresh_bool_enabled "${ARCHITECTURE_VIEW_10CLASS_SUBMIT_OFFLINE_TRANSFER}"; then
  offline_cache_jid="$(submit_job "av10_ablate_offline_cache" \
...
architecture_view_10class_ablation_submission:
  ...
  outputs:
    ...
    hlt_part_baseline_checkpoint: ${ARCHITECTURE_VIEW_10CLASS_STANDALONE_MODEL_ROOT}/part/best_model_val.pt
