...
: "${LOCAL_RESIDUAL_FIELD_RECO_NUM_WORKERS:=0}"
: "${LOCAL_RESIDUAL_FIELD_TAGGER_NUM_WORKERS:=0}"
...
export CONDA_ENV CONDA_BASE PYTHONNOUSERSITE DEVICE SKIP_EXISTING OVERWRITE
...
export LOCAL_RESIDUAL_FIELD_RECO_NUM_WORKERS LOCAL_RESIDUAL_FIELD_TAGGER_NUM_WORKERS
