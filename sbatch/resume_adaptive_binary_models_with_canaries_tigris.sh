...
b1_response="$(
  sbatch --parsable \
    ...
    --time=02:00:00 \
    --gres=gpu:gh200:1 \
    --export="${common_export},ABPH_ACCEPT_TRUNCATED_CANARY=1,ABPH_EVAL_INTERVAL=1,ABPH_RECONSTRUCTOR_PARALLELISM=ddp8,ABPH_JOB_LAUNCHER=srun,ABPH_DISTRIBUTED_NODES=8,ABPH_DISTRIBUTED_NTASKS=8,ABPH_DISTRIBUTED_NTASKS_PER_NODE=1,ABPH_DISTRIBUTED_GPUS_PER_NODE=1,ABPH_DISTRIBUTED_WORLD_SIZE=8" \
    --chdir="${PROJECT_DIR}" \
