...
: "${CONSTRAINED_C2F_REQUIRE_EXISTING_CALIBRATION:=0}"
...
if fresh_bool_enabled "${CONSTRAINED_C2F_REQUIRE_EXISTING_CALIBRATION}" && [[ -z "${CONSTRAINED_C2F_EXISTING_CALIBRATION_JOB_ID}" ]]; then
  echo "An existing calibration job was required but CONSTRAINED_C2F_EXISTING_CALIBRATION_JOB_ID is empty" >&2
  exit 2
fi
...
export CONSTRAINED_C2F_EXISTING_CALIBRATION_JOB_ID CONSTRAINED_C2F_REQUIRE_EXISTING_CALIBRATION
