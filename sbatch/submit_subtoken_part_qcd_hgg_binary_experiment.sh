...
: "${SUBTOKEN_PART_QCD_HGG_BINARY_MANIFEST_TIME:=04:00:00}"
: "${SUBTOKEN_PART_QCD_HGG_BINARY_HLT_CACHE_TIME:=1-00:00:00}"
: "${SUBTOKEN_PART_QCD_HGG_COMPAT_TIME:=3-00:00:00}"
...
: "${SUBTOKEN_PART_QCD_HGG_OFFLINE_TEACHER_TIME:=2-00:00:00}"
...
: "${SUBTOKEN_PART_QCD_HGG_VERSION_B_TIME:=3-00:00:00}"
...
: "${SUBTOKEN_PART_QCD_HGG_VERSION_B_REPORT_TIME:=04:00:00}"
