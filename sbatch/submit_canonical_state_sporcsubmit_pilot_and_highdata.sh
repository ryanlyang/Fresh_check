...
export CANONICAL_STATE_CHECKPOINT_POLICY="${CANONICAL_STATE_SPORC_CHECKPOINT_POLICY:-dependency}"
export CANONICAL_STATE_SAVE_LAST_CHECKPOINT="${CANONICAL_STATE_SPORC_SAVE_LAST_CHECKPOINT:-0}"
