#!/usr/bin/env python3
"""Generate Step 9 prediction blocks from a trained aggressive reconstructor."""
...
from teacher_logit_reco.predict_aggressive_reconstructors import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--reco-architecture",
        default=None,
        help="Optional strict check: aggressive_gt, aggressive_pn, aggressive_pfn, or aggressive_pcnn.",
    )
...
def main() -> int:
    ...
    report = collect_teacher_logit_aggressive_predictions(config)
    print("teacher_logit_aggressive_predictions_complete:")
