...
from teacher_logit_reco.train_particle_net import (  # noqa: E402
...
def main() -> int:
    ...
    report = train_teacher_logit_particle_net_reco(config)
    print("teacher_logit_particle_net_training_complete:")
