#!/usr/bin/env python3
"""Write Step 15 final report tables for subtoken Particle Transformer runs."""
...
from teacher_logit_reco.subtoken_part.reports import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--primary-metric", choices=SUBTOKEN_PART_SELECTION_METRICS, default=None)
...
def main() -> int:
    ...
    config = SubtokenPartReportConfig(
    ...
    report = build_subtoken_part_final_report(config)
    summary = report["comparison_summary"]
    print("subtoken_part_final_report_complete:")
