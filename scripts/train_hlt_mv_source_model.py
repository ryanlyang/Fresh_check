#!/usr/bin/env python3
"""Train one scratch source ParT model for HLT multiview source/fusion."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--epochs", type=int, default=HLT_MV_SOURCE_DEFAULT_EPOCHS)
    parser.add_argument("--batch-size", type=int, default=HLT_MV_SOURCE_DEFAULT_BATCH_SIZE)
    parser.add_argument("--eval-batch-size", type=int, default=HLT_MV_SOURCE_DEFAULT_EVAL_BATCH_SIZE)
    parser.add_argument("--lr", type=float, default=HLT_MV_SOURCE_DEFAULT_LR)
    parser.add_argument("--weight-decay", type=float, default=HLT_MV_SOURCE_DEFAULT_WEIGHT_DECAY)
    parser.add_argument("--early-stop-patience", type=int, default=HLT_MV_SOURCE_DEFAULT_EARLY_STOP_PATIENCE)
    parser.add_argument("--grad-clip-norm", type=float, default=HLT_MV_SOURCE_DEFAULT_GRAD_CLIP_NORM)
    parser.add_argument("--num-workers", type=int, default=0)
    parser.add_argument("--device", default="auto")
    parser.add_argument("--seed", type=int, default=None)
    parser.add_argument("--model-size", default=HLT_MV_SOURCE_DEFAULT_MODEL_SIZE, choices=["tiny", "base", "large"])
    parser.add_argument("--max-train-batches", type=int, default=None)
    parser.add_argument("--max-val-batches", type=int, default=None)
    parser.add_argument("--max-final-test-batches", type=int, default=None)
    parser.add_argument("--max-train-jets", type=int, default=HLT_MV_SOURCE_DEFAULT_MAX_TRAIN_JETS)
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = train_hlt_mv_source(config)
