#!/usr/bin/env python3
"""Write Step 14 final report tables for local-compression ParT variants."""
...
from teacher_logit_reco.local_compression_part.reports import (  # noqa: E402
    LocalCompressionPartReportConfig,
    build_local_compression_part_report,
)
from teacher_logit_reco.local_compression_part.train import LOCAL_COMPRESSION_SELECTION_METRICS  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--primary-metric", choices=LOCAL_COMPRESSION_SELECTION_METRICS, default=None)
    parser.add_argument("--comparison-split", choices=("model_val", "stack_val", "final_test"), default=None)
    parser.add_argument("--variants", nargs="*", default=())
    parser.add_argument("--baseline-variant", default="hlt_part_baseline_recheck")
...
def main() -> int:
    ...
    config = LocalCompressionPartReportConfig(
    ...
    report = build_local_compression_part_report(config)
    summary = report["comparison_summary"]
    print("local_compression_part_report_complete:")
