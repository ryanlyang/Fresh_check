#!/usr/bin/env python3
"""Run the first PN -> ParT teacher-logit reconstruction experiment."""
...
from teacher_logit_reco.pn_first_experiment import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=[],
        help="Optional comparison formatted name:prediction_dir:model_name. Repeat for raw_hlt/gt_reco/hetero.",
    )
...
def main() -> int:
    ...
    report = run_teacher_logit_particle_net_first_experiment(config)
    print("teacher_logit_particle_net_first_experiment_complete:")
