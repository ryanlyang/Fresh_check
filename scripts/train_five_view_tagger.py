#!/usr/bin/env python3
"""Train the Step 10 set-matching five-view tagger."""
...
from teacher_logit_reco.set_matching.five_view_train import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--drop-views", nargs="*", default=())
    parser.add_argument("--shuffle-view-labels", action="store_true")
...
def main() -> int:
    ...
    config = FiveViewTaggerTrainConfig(
        ...
        drop_views=tuple(args.drop_views),
        shuffle_view_labels=args.shuffle_view_labels,
    ...
    print("set_matching_five_view_tagger_training_complete:")
