...
from teacher_logit_reco.train_particle_cnn import (  # noqa: E402
...
def main() -> int:
    ...
    report = train_teacher_logit_particle_cnn_reco(config)
    print("teacher_logit_particle_cnn_training_complete:")
