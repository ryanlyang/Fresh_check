...
from teacher_logit_reco.subtoken_part.config import (  # noqa: E402
    SUBTOKEN_PART_DUAL_FUSION_MODES,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dual-fusion-mode",
        choices=SUBTOKEN_PART_DUAL_FUSION_MODES,
        default="cross_attention_class_token_fusion",
    )
    parser.add_argument("--standard-branch-layers", type=int, default=6)
    parser.add_argument("--disable-standard-branch-pairwise-bias", action="store_true")
...
def main() -> int:
    ...
    config = SubtokenDistillTrainConfig(
        ...
        dual_fusion_mode=args.dual_fusion_mode,
        standard_branch_layers=args.standard_branch_layers,
        standard_branch_use_pairwise_bias=not bool(args.disable_standard_branch_pairwise_bias),
