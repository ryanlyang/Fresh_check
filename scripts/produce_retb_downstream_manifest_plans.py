...
FACTORY_SYMBOLS = (
    ...
    "build_shortlisted_500k_control_training_manifest_plan",
    "build_shortlisted_500k_controls_manifest_plan",
    "build_scale_refit_normalizers_manifest_plan",
    "build_scale_refit_teachers_manifest_plan",
    "build_scale_refit_offline_experts_manifest_plan",
    "build_scale_refit_targets_manifest_plan",
    "build_scale_refit_native_manifest_plan",
    "build_scale_refit_native_fusion_manifest_plan",
    "build_scale_refit_predictors_manifest_plan",
    "build_scale_refit_calibrations_manifest_plan",
    "build_scale_refits_manifest_plan",
    "build_scale_joint_training_manifest_plan",
    "build_scale_graph_datasets_manifest_plan",
    "build_scale_refiner_training_manifest_plan",
    "build_scale_final_consumer_training_manifest_plan",
    "build_scale_graph_export_manifest_plan",
