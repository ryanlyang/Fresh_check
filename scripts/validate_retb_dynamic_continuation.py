#!/usr/bin/env python3
"""Fail closed unless a dynamic RETB task manifest has its selector binding."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    digest = validate_published_dynamic_continuation(
        campaign=campaign,
        ...
        json.dumps(
            {
                ...
                "continuation_binding_sha256": digest,
            },
            indent=2,
            sort_keys=True,
        )
