...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--hlt2-checkpoint", default=None)
    parser.add_argument("--epochs", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_EPOCHS)
    parser.add_argument(
        "--head-warmup-epochs",
        type=int,
        default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_HEAD_WARMUP_EPOCHS,
    )
    parser.add_argument("--batch-size", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_BATCH_SIZE)
    parser.add_argument("--eval-batch-size", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_EVAL_BATCH_SIZE)
    parser.add_argument("--head-warmup-lr", type=float, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_HEAD_WARMUP_LR)
    parser.add_argument("--branch-lr", type=float, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_BRANCH_LR)
    parser.add_argument("--head-lr", type=float, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_HEAD_LR)
    parser.add_argument("--weight-decay", type=float, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_WEIGHT_DECAY)
    parser.add_argument("--dropout", type=float, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_DROPOUT)
    parser.add_argument("--fusion-hidden-dim", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_FUSION_HIDDEN_DIM)
    parser.add_argument("--representation-dim", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_REPRESENTATION_DIM)
    parser.add_argument("--early-stop-patience", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_EARLY_STOP_PATIENCE)
    parser.add_argument("--grad-clip-norm", type=float, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_GRAD_CLIP_NORM)
    parser.add_argument("--num-workers", type=int, default=0)
    parser.add_argument("--device", default="auto")
    parser.add_argument("--seed", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_SEED)
    parser.add_argument(
        "--model-size",
        default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_MODEL_SIZE,
        choices=["tiny", "base", "large"],
    )
    parser.add_argument("--max-train-batches", type=int, default=None)
    parser.add_argument("--max-val-batches", type=int, default=None)
    parser.add_argument("--max-final-test-batches", type=int, default=None)
    parser.add_argument("--max-train-jets", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_MAX_TRAIN_JETS)
    parser.add_argument("--max-val-jets", type=int, default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_MAX_VAL_JETS)
    parser.add_argument(
        "--max-final-test-jets",
        type=int,
        default=HLT_MV_PRETRAINED_DUALVIEW_DEFAULT_MAX_FINAL_TEST_JETS,
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = build_hlt_mv_pretrained_dualview_config(
        ...
        hlt2_checkpoint=None if args.hlt2_checkpoint is None else Path(args.hlt2_checkpoint),
        seed=args.seed,
        epochs=args.epochs,
    ...
    report = train_hlt_mv_pretrained_dualview(config)
