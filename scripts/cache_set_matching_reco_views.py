#!/usr/bin/env python3
"""Cache reconstructed views from a trained set-matching reconstructor."""
...
from teacher_logit_reco.set_matching.cache import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--splits", nargs="+", default=list(DEFAULT_CACHE_SPLITS))
    ...
    parser.add_argument("--skip-set-matching-metrics", action="store_true")
...
def main() -> int:
    ...
    config = SetMatchingRecoViewCacheConfig(
        ...
        compute_set_matching_metrics=not bool(args.skip_set_matching_metrics),
    ...
    report = cache_set_matching_reco_views(config)
    print("set_matching_reconstructed_view_cache_complete:")
