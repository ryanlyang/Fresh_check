...
from teacher_logit_reco.train_particle_flow import (  # noqa: E402
...
def main() -> int:
    ...
    report = train_teacher_logit_particle_flow_reco(config)
    print("teacher_logit_particle_flow_training_complete:")
