#!/usr/bin/env python3
"""Generate Step 6 prediction blocks from a trained PN teacher-logit reconstructor."""
...
from teacher_logit_reco.predict_particle_net import (  # noqa: E402
...
def main() -> int:
    ...
    report = collect_teacher_logit_particle_net_predictions(config)
    print("teacher_logit_particle_net_predictions_complete:")
