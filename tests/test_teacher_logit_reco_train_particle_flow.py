...
from teacher_logit_reco.train_particle_flow import (
    EXPERIMENT_STEP,
...
class TeacherLogitParticleFlowTrainConfigTests(unittest.TestCase):
    ...
    def test_model_and_loss_config_factories(self):
        cfg = TeacherLogitParticleFlowTrainConfig(
            output_dir="out",
            manifest_path="manifest.json.gz",
            hlt_cache_dir="hlt",
            teacher_checkpoint="teacher.pt",
        ...
        self.assertEqual(model_cfg.phi_dims, (16, 32))
    ...
    def test_checkpoint_payload_records_particle_flow_architecture(self):
        cfg = TeacherLogitParticleFlowTrainConfig(
            output_dir="out",
            manifest_path="manifest.json.gz",
            hlt_cache_dir="hlt",
        ...
        self.assertEqual(payload["model_config"]["phi_dims"], [16, 32])
        self.assertEqual(payload["model_config"]["reconstructor_architecture"], "particle_flow")
...
class TeacherLogitParticleFlowTinyTrainTests(unittest.TestCase):
    def test_tiny_training_writes_required_outputs(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            report = train_teacher_logit_particle_flow_reco(
                cfg,
                teacher=teacher,
