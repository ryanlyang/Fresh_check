...
class PD10V2Step6SbatchTests(unittest.TestCase):
    ...
    def test_v2_submitter_queues_dependency_graph(self):
        ...
        self.assertIn("validate_dependency_list \"PD10_V2_PARTICLE_TEACHER_UPSTREAM_DEPENDENCY\"", submitter)
        self.assertIn("Do not pass placeholder text such as HLT_TEACHER_JOB", submitter)
        self.assertIn("submitted_job_id", submitter)
        self.assertIn("require_artifact_or_submitted_job", submitter)
